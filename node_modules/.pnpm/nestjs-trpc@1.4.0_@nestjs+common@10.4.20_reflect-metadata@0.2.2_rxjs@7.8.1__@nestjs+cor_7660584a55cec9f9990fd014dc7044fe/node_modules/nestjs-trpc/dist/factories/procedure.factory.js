...
let ProcedureFactory = class ProcedureFactory {
    ...
    serializeProcedures(procedures, instance, camelCasedRouterName, procedureBuilder, routerMiddlewares) {
        ...
        for (const procedure of procedures) {
            ...
            const procedureInstance = this.createProcedureInstance(procedureBuilder, middlewares, routerMiddlewares);
    ...
    createProcedureInstance(procedureBuilder, procedureDef, routeProcedureDef) {
