/*
  ...
  - The values [CAMPUS] on the enum `Classification` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "Classification_new" AS ENUM ('DEPARTMENTAL', 'INSTITUTIONAL', 'INTERNAL', 'CONFIDENTIAL', 'FOR_APPROVAL');
